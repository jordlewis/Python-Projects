...
def load_gui(self):
    ...
    # Creates the labels on the widget and places the label using the grid manager
    ...
    # Creates the text boxes located underneath the labels using the grid manager
    ...
    # Define the listbox with a scrolbar and grid them
